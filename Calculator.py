...
btn_plus=tk.Button(root,text="+",command=lambda:add_to_calculation("+"),width=5,font=("Arial",15),bg="grey",fg="white")
btn_plus.grid(row=2,column=4)
btn_minus=tk.Button(root,text="-",command=lambda:add_to_calculation("-"),width=5,font=("Arial",15),bg="grey",fg="white")
btn_minus.grid(row=3,column=4)
btn_mul=tk.Button(root,text="*",command=lambda:add_to_calculation("*"),width=5,font=("Arial",15),bg="grey",fg="white")
btn_mul.grid(row=4,column=4)
btn_div=tk.Button(root,text="/",command=lambda:add_to_calculation("/"),width=5,font=("Arial",15),bg="grey",fg="white")
...
btn_clear=tk.Button(root,text="C",command=clear_field,width=11,font=("Arial",14),bg="grey",fg="white")
btn_clear.grid(row=6,column=1,columnspan=2)
btn_equals=tk.Button(root,text="=",command=evaluate_calculation,width=5,font=("Arial",15),bg="grey",fg="white")
btn_equals.grid(row=6,column=4)
btn_backspace=tk.Button(root,text="x",command=backspace,width=5,font=("Arial",15),bg="grey",fg="white")
